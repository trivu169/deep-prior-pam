...
sensor_angle = 2*pi;%2*pi;%3*pi/2;      % [rad]
sensor_pos = [0, 0];        % [m]
num_sensor_points = 512;%256;%70;
...
%% Save Images
save('p0_recon_full.mat', 'p0_recon')
save('p0_recon_interp_full.mat', 'p0_recon_interp')
imwrite(uint8(255 * mat2gray(p0_recon)), 'p0_recon_full.png')
imwrite(uint8(255 * mat2gray(p0_recon_interp)), 'p0_recon_interp_full.png')